...
import {URL as specialURL} from '../../env'
import './style.css';
...
function DocumentDisplay() {
  ...
  useEffect(() => {
    const fetchDocuments = async () => {
      try {
        ...
        const response = await axios.get(specialURL+'/get-doc', {
          headers: {
  ...
  return (
    <div>
      <h1 style={{ textAlign: 'center' }}>Bone Fractures Related Medical Documents</h1>
